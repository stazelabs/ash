...
var registry = []VerbSchema{
	...
	},
	{
		...
		Args: []ArgSchema{
			...
			{Name: "path", Type: "string", Required: true,
				Description: "File or directory to search; paths mirror --path form.",
				Long:        "File or directory to search. Returned match paths mirror the input form: absolute input yields absolute paths, relative input yields relative paths."},
			{Name: "glob", Type: "string", Default: "**",
